...
//                            dark:hover:text-white px-3 py-2 text-sm font-medium
...
// 							className="ml-4 inline-flex items-center justify-center p-2 rounded-md
...
// 								key={item.id}
// 								href={item.href}
// 								className="block text-gray-700 dark:text-gray-300 hover:text-gray-900
//                          dark:hover:text-white px-3 py-2 text-base font-medium
//                          transition-colors duration-200"
